...
- **TUI scroll fix:** Screen stays put while reading up in live TUIs (Claude Code, Command Code, Antigravity, etc.).

## Troubleshooting
- [Screen jumps to the bottom when scrolling up in a live TUI](docs/scroll-jump-fix.md) — why it happens and how to stop it.
